...
export function LargeButton({ route }: { route: '/barplot' | '/wordcloud' }) {
  return (
    <Link to={route}>
      <button className="group h-[300px] w-[400px] border  text-start hover:border-blue-500 rounded-lg overflow-hidden border-white transition-transform duration-1000">
        <div className="relative z-10 pt-4 h-[380px] w-[500px] bg-blue-500 rounded-lg transition-transform duration-500 group-hover:-translate-y-full"></div>
        <div
